...
func TestOffsetCurve_Point(t *testing.T) {
	checkOffsetCurve(t,
		"POINT (0 0)", 1,
		"LINESTRING EMPTY")
}

func TestOffsetCurve_Empty(t *testing.T) {
	checkOffsetCurve(t,
		"LINESTRING EMPTY", 1,
		"LINESTRING EMPTY")
}

func TestOffsetCurve_ZeroLenLine(t *testing.T) {
	checkOffsetCurve(t,
		"LINESTRING (1 1, 1 1)", 1,
		"LINESTRING EMPTY")
}

func TestOffsetCurve_ZeroOffsetLine(t *testing.T) {
	checkOffsetCurve(t,
		"LINESTRING (0 0, 1 0, 1 1)", 0,
		"LINESTRING (0 0, 1 0, 1 1)")
}

func TestOffsetCurve_ZeroOffsetPolygon(t *testing.T) {
	checkOffsetCurve(t,
		"POLYGON ((1 9, 9 1, 1 1, 1 9))", 0,
		"LINESTRING (1 9, 1 1, 9 1, 1 9)")
}

func TestOffsetCurve_RepeatedPoint(t *testing.T) {
	checkOffsetCurve(t,
		"LINESTRING (4 9, 1 2, 7 5, 7 5, 4 9)", 1,
		"LINESTRING (4.24 7.02, 2.99 4.12, 5.48 5.36, 4.24 7.02)")
}

func TestOffsetCurve_Segment1Short(t *testing.T) {
	checkOffsetCurveWithTolerance(t,
		"LINESTRING (2 2, 2 2.0000001)", 1,
		"LINESTRING (1 2, 1 2.0000001)",
		0.00000001)
}

func TestOffsetCurve_Segment1(t *testing.T) {
	checkOffsetCurve(t,
		"LINESTRING (0 0, 9 9)", 1,
		"LINESTRING (-0.71 0.71, 8.29 9.71)")
}

func TestOffsetCurve_Segment1Neg(t *testing.T) {
	checkOffsetCurve(t,
		"LINESTRING (0 0, 9 9)", -1,
		"LINESTRING (0.71 -0.71, 9.71 8.29)")
}

func TestOffsetCurve_Segments2(t *testing.T) {
	checkOffsetCurve(t,
...
func TestOffsetCurve_Segments3(t *testing.T) {
	checkOffsetCurve(t,
...
func TestOffsetCurve_AsymmetricU(t *testing.T) {
	wkt := "LINESTRING (1 1, 9 1, 9 2, 5 2)"
	checkOffsetCurve(t,
		wkt, 1,
		"LINESTRING (1 2, 4 2)")
	checkOffsetCurve(t,
...
func TestOffsetCurve_SymmetricU(t *testing.T) {
	wkt := "LINESTRING (1 1, 9 1, 9 2, 1 2)"
	checkOffsetCurve(t,
		wkt, 1,
		"LINESTRING EMPTY")
	checkOffsetCurve(t,
...
func TestOffsetCurve_EmptyResult(t *testing.T) {
	checkOffsetCurve(t,
		"LINESTRING (3 5, 5 7, 7 5)", -4,
		"LINESTRING EMPTY")
}

func TestOffsetCurve_SelfCross(t *testing.T) {
	checkOffsetCurve(t,
		"LINESTRING (50 90, 50 10, 90 50, 10 50)", 10,
		"MULTILINESTRING ((60 90, 60 60), (60 40, 60 34.14, 65.85 40, 60 40), (40 40, 10 40))")
}

func TestOffsetCurve_SelfCrossNeg(t *testing.T) {
	checkOffsetCurve(t,
		"LINESTRING (50 90, 50 10, 90 50, 10 50)", -10,
...
func TestOffsetCurve_SelfCrossDartOutside(t *testing.T) {
	checkOffsetCurve(t,
		"LINESTRING (60 50, 10 80, 50 10, 90 80, 40 50)", -10,
...
func TestOffsetCurve_OverlapTriangleInside(t *testing.T) {
	checkOffsetCurve(t,
		"LINESTRING (70 80, 10 80, 50 10, 90 80, 40 80)", 10,
		"LINESTRING (70 70, 40 70, 27.23 70, 50 30.15, 72.76 70, 70 70)")
}

func TestOffsetCurve_OverlapTriangleOutside(t *testing.T) {
	checkOffsetCurve(t,
		"LINESTRING (70 80, 10 80, 50 10, 90 80, 40 80)", -10,
...
func TestOffsetCurve_MultiPoint(t *testing.T) {
	checkOffsetCurve(t,
		"MULTIPOINT ((0 0), (1 1))", 1,
		"LINESTRING EMPTY")
}

func TestOffsetCurve_MultiLine(t *testing.T) {
	checkOffsetCurve(t,
...
func TestOffsetCurve_PolygonWithHole(t *testing.T) {
	checkOffsetCurve(t,
...
func TestOffsetCurve_Joined(t *testing.T) {
	input := "LINESTRING (0 50, 100 50, 50 100, 50 0)"
	checkOffsetCurveJoined(t, input, 10,
...
func TestOffsetCurve_InfiniteLoop(t *testing.T) {
	checkOffsetCurveNoExpected(t,
		"LINESTRING (21 101, -1 78, 12 43, 50 112, 73 -5, 19 2, 87 85, -7 38, 105 40)", 4)
}

func TestOffsetCurve_OffsetError(t *testing.T) {
	checkOffsetCurve(t,
...
func TestOffsetCurve_QuadSegs(t *testing.T) {
	checkOffsetCurveWithParams(t,
...
func TestOffsetCurve_JoinBevel(t *testing.T) {
	checkOffsetCurveWithParams(t,
		"LINESTRING (20 20, 50 50, 80 20)",
		10, -1, OperationBuffer_BufferParameters_JOIN_BEVEL, -1,
		"LINESTRING (12.93 27.07, 42.93 57.07, 57.07 57.07, 87.07 27.07)")
}

func TestOffsetCurve_JoinMitre(t *testing.T) {
	checkOffsetCurveWithParams(t,
		"LINESTRING (20 20, 50 50, 80 20)",
		10, -1, OperationBuffer_BufferParameters_JOIN_MITRE, -1,
		"LINESTRING (12.93 27.07, 50 64.14, 87.07 27.07)")
}

func TestOffsetCurve_MinQuadrantSegments(t *testing.T) {
	checkOffsetCurveWithParams(t,
		...
		-11, 0, OperationBuffer_BufferParameters_JOIN_MITRE, -1,
		"LINESTRING (553770.76 177759.13, 553777.54 177758.32)")
}

func TestOffsetCurve_MinQuadrantSegments_QGIS(t *testing.T) {
	checkOffsetCurveWithParams(t,
		"LINESTRING (421 622, 446 625, 449 627)",
		133, 0, OperationBuffer_BufferParameters_JOIN_MITRE, -1,
		"LINESTRING (405.15 754.05, 416.3 755.39)")
}

func TestOffsetCurve_MitreJoinError(t *testing.T) {
	checkOffsetCurveWithParams(t,
		...
		-0.045, 0, OperationBuffer_BufferParameters_JOIN_MITRE, -1,
...
func TestOffsetCurve_MitreJoinErrorSimple(t *testing.T) {
	checkOffsetCurveWithParams(t,
...
func TestOffsetCurve_MitreJoinSingleLine(t *testing.T) {
	checkOffsetCurveWithParams(t,
		...
		-0.002, 0, OperationBuffer_BufferParameters_JOIN_MITRE, -1,
...
const offsetCurve_equalsTol = 0.05

var offsetCurve_testFactory = Geom_NewGeometryFactoryDefault()

func checkOffsetCurve(t *testing.T, wkt string, distance float64, wktExpected string) {
	t.Helper()
	checkOffsetCurveWithTolerance(t, wkt, distance, wktExpected, 0.05)
}

func checkOffsetCurveWithParams(t *testing.T, wkt string, distance float64, quadSegs, joinStyle int, mitreLimit float64, wktExpected string) {
	t.Helper()
	checkOffsetCurveWithParamsAndTolerance(t, wkt, distance, quadSegs, joinStyle, mitreLimit, wktExpected, offsetCurve_equalsTol)
}

func checkOffsetCurveJoined(t *testing.T, wkt string, distance float64, wktExpected string) {
	t.Helper()
	geom := offsetCurveRead(wkt)
	result := OperationBuffer_OffsetCurve_GetCurveJoined(geom, distance)
	...
	expected := offsetCurveRead(wktExpected)
	offsetCurveCheckEqual(t, expected, result, offsetCurve_equalsTol)
}

func checkOffsetCurveWithTolerance(t *testing.T, wkt string, distance float64, wktExpected string, tolerance float64) {
	t.Helper()
	geom := offsetCurveRead(wkt)
	result := OperationBuffer_OffsetCurve_GetCurve(geom, distance)
	//System.out.println(result);
	...
	expected := offsetCurveRead(wktExpected)
	offsetCurveCheckEqual(t, expected, result, tolerance)
}

func checkOffsetCurveWithParamsAndTolerance(t *testing.T, wkt string, distance float64, quadSegs, joinStyle int, mitreLimit float64, wktExpected string, tolerance float64) {
	t.Helper()
	geom := offsetCurveRead(wkt)
	result := OperationBuffer_OffsetCurve_GetCurveWithParams(geom, distance, quadSegs, joinStyle, mitreLimit)
	//System.out.println(result);
...
func checkOffsetCurveNoExpected(t *testing.T, wkt string, distance float64) {
	t.Helper()
	geom := offsetCurveRead(wkt)
	OperationBuffer_OffsetCurve_GetCurve(geom, distance)
	// Just verifies no infinite loop or panic occurs
}

func offsetCurveRead(wkt string) *Geom_Geometry {
	reader := Io_NewWKTReaderWithFactory(offsetCurve_testFactory)
...
func offsetCurveCheckEqual(t *testing.T, expected, actual *Geom_Geometry, tolerance float64) {
	t.Helper()
	if expected.IsEmpty() && actual.IsEmpty() {
		return
	}
	if expected.IsEmpty() != actual.IsEmpty() {
		t.Fatalf("expected empty=%v, got empty=%v\nexpected: %s\ngot: %s",
			expected.IsEmpty(), actual.IsEmpty(),
			expected.String(), actual.String())
	}
	if !expected.EqualsNorm(actual) {
		hd := AlgorithmDistance_DiscreteHausdorffDistance_Distance(expected, actual)
		if hd > tolerance {
			t.Fatalf("Hausdorff distance %v exceeds tolerance %v\nexpected: %s\ngot: %s",
				hd, tolerance,
				expected.String(), actual.String())
		}
	}
