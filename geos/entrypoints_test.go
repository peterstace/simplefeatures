...
func TestClipByRect(t *testing.T) {
	for _, tc := range []struct {
		...
		},
		{
			...
			rect:  geom.NewEnvelopeXY(1, 1, 5, 5),
		...
		},
		{
			...
			rect:  geom.NewEnvelopeXY(2, 2, 5, 5),
