...
func TestConvexHull(t *testing.T) {
	for i, tt := range []struct {
		...
		},
		{
			...
			output: "POLYGON((1 0,1 1,0 1,0 0,1 0))",
		},
		{
			input:  "POLYGON((0 0,0 1,1 0,0 0))",
			output: "POLYGON((1 0,0 1,0 0,1 0))",
		},
		{
			input:  "POLYGON EMPTY",
