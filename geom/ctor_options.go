...
// DisableExpensiveValidations disables validations during Geometry
// construction that are computationally expensive. There are several
// implications as a result of using this option:
//
// 1. If the geometry is invalid, then the results of geometric calculations
//    resulting from the geometry may be invalid.
//
