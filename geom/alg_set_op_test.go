...
func TestBinaryOp(t *testing.T) {
	for i, geomCase := range []struct {
		...
		},
		{
			...
			union:  "POLYGON((-0.9999999999999983 0,-1 0,-0.9999999999999968 0.0000000000000032,-0.9 0.2,-0.8095238095238095 0.1904761904761905,0 1,0 0.1052631578947369,1 0,-0.9 -0.2,-1 -0.0000000000000032,-0.9999999999999983 0))", // TODO: I'm not 100% sure about this, but it's what JTS port is giving back.
			relate: "212101212",
		},
		{
		...
		{
			// JTS bug (https://github.com/locationtech/jts/issues/1175):
			// exterior-boundary (position 7) should be '0' but JTS returns 'F'.
