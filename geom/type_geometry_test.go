...
func TestGeometryIsCWandIsCCW(t *testing.T) {
	for i, tt := range []struct {
		...
		{"POINT(1 1)", TypePoint, false, false, "undefined"},
		{"POINT EMPTY", TypePoint, false, false, "undefined"},
		{"MULTIPOINT EMPTY", TypeMultiPoint, false, false, "undefined"},
		{"MULTIPOINT ((10 40), (40 30), (20 20), (30 10))", TypeMultiPoint, false, false, "undefined"},
		{"LINESTRING(1 2,3 4)", TypeLineString, false, false, "undefined"},
		{"LINESTRING(1 2,3 4,5 6)", TypeLineString, false, false, "undefined"},
		{"LINESTRING EMPTY", TypeLineString, false, false, "undefined"},
		{"MULTILINESTRING ((10 10, 20 20, 10 40),(40 40, 30 30, 40 20, 30 10))", TypeMultiLineString, false, false, "undefined"},
		{"MULTILINESTRING EMPTY", TypeMultiLineString, false, false, "undefined"},
		{"MULTILINESTRING(EMPTY)", TypeMultiLineString, false, false, "undefined"},
		...
		{"POLYGON EMPTY", TypePolygon, false, false, "empty"},
		...
		{"MULTIPOLYGON EMPTY", TypeMultiPolygon, false, false, "empty"},
		{"MULTIPOLYGON(EMPTY)", TypeMultiPolygon, false, false, "empty"},
		...
		{"GEOMETRYCOLLECTION EMPTY", TypeGeometryCollection, false, false, "empty"},
		{"GEOMETRYCOLLECTION(POINT(1 1))", TypeGeometryCollection, false, false, "first undefined"},
		{"GEOMETRYCOLLECTION(POLYGON((0 0,0 5,5 5,5 0,0 0)), POINT(1 1))", TypeGeometryCollection, false, false, "first CW, second undefined"},
	} {
		t.Run(strconv.Itoa(i), func(t *testing.T) {
			t.Log("wkt:", tt.wkt)
			g := geomFromWKT(t, tt.wkt)
