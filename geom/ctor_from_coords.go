...
//
// It doesn't perform any validation on the result. The [Point.Validate] method can be
...
//
// It doesn't perform any validation on the result. The [MultiPoint.Validate] method can be
// used to check the validity of the result if needed.
...
// the function will panic.
//
// It doesn't perform any validation on the result. The [LineString.Validate] method can be
// used to check the validity of the result if needed.
...
// coordinates of its [LineString]s, each in its own slice, in the form x1, y1,
// x2, y2, ..., xn, yn. If the number of coordinates for each [LineString] is not
// a multiple of 2 the function will panic.
//
// It doesn't perform any validation on the result. The [MultiLineString.Validate] method can be
// used to check the validity of the result if needed.
...
// and m coordinates of its [LineString]s, each in its own slice, in the form x1,
...
// panic.
//
// It doesn't perform any validation on the result. The [Polygon.Validate] method can be
// used to check the validity of the result if needed.
...
// of its [Polygon]s, each in its own slice of rings. Ring coordinates are in the
// form x1, y1, x2, y2, ..., xn, yn, x1, y1 (the first and last coordinates of
// each ring should be the same). If the number of coordinates for each ring is
// not a multiple of 2 the function will panic.
//
// It doesn't perform any validation on the result. The [MultiPolygon.Validate] method can be
// used to check the validity of the result if needed.
...
// coordinates of its [Polygon]s, each in its own slice of rings. Ring
