...
func TestUnmarshalTWKBValid(t *testing.T) {
	for _, tc := range []struct {
		...
		{"line string empty", "021000", "LINESTRING EMPTY"},
		{"line string empty due to no points", "020000", "LINESTRING EMPTY"},
		...
		{"polygon empty", "031000", "POLYGON EMPTY"},
		{"polygon empty due to no rings", "030000", "POLYGON EMPTY"},
		{"polygon", "030002040000060000060500040203000202000001", "POLYGON((0 0,3 0,3 3,0 3,0 0),(1 1,1 2,2 2,2 1,1 1))"},
		...
		{"multipoint empty", "0410", "MULTIPOINT EMPTY"},
		{"multipoint empty due to no points", "040000", "MULTIPOINT EMPTY"},
		{"multipoint with size & bbox & ids", "04070b0004020402000200020404", "MULTIPOINT(0 1,2 3)"},
		{"multilinestring empty", "0510", "MULTILINESTRING EMPTY"},
		{"multilinestring empty due to no linestrings", "050000", "MULTILINESTRING EMPTY"},
		{"multilinestring", "050002020000020203020202020202", "MULTILINESTRING((0 0,1 1),(2 2,3 3,4 4))"},
		{"multipolygon empty", "0610", "MULTIPOLYGON EMPTY"},
		{"multipolygon empty due to no points", "060000", "MULTIPOLYGON EMPTY"},
		{"multipolygon with empty polygon", "06000100", "MULTIPOLYGON(EMPTY)"},
		{"multipolygon with two empty polygons", "0600020000", "MULTIPOLYGON(EMPTY,EMPTY)"},
		{"multipolygon with empty and non-empty", "0600020001040000060000060500", "MULTIPOLYGON(EMPTY,((0 0,3 0,3 3,0 3,0 0)))"},
		{"multipolygon", "0600020104000006000006050001040802000202000001", "MULTIPOLYGON(((0 0,3 0,3 3,0 3,0 0)),((4 4,4 5,5 5,5 4,4 4)))"},
		{"geometry collection empty", "0710", "GEOMETRYCOLLECTION EMPTY"},
		{"geometry collection empty due to no contents", "070000", "GEOMETRYCOLLECTION EMPTY"},
